        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                href="https://github.com/rishabh053" 
                target="_blank" 
                rel="noreferrer" 
              ...
              <a 
                href="https://www.linkedin.com/in/therishabh/" 
                target="_blank" 
                rel="noreferrer" 
                className="text-muted-foreground hover:text-primary transition-colors"
                aria-label="LinkedIn"
              ...
              <a 
                href="https://twitter.com/rishabh053" 
                target="_blank" 
                rel="noreferrer" 
                className="text-muted-foreground hover:text-primary transition-colors"
                aria-label="Twitter"
              ...
              <a 
                href="mailto:rishabh053@gmail.com" 
                className="text-muted-foreground hover:text-primary transition-colors"
                aria-label="Email"
              >
                <Mail size={20} />
